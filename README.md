...
This repository was created as part of the **100Hires portfolio project application process**. It documents the setup, tooling, and workflow used to establish a public GitHub repository and development environment for the application. The project demonstrates practical experience with modern development tools, version control, and self-directed learning.
...
Issues were addressed through **research**, **experimentation**, and **troubleshooting**:

- Conducted repeated Marketplace searches using multiple keywords and browsed available extension categories to locate Claude Code and Codex
- Reviewed official documentation, release notes, and community discussions to verify whether the required extensions remained supported or had changed names
- Confirmed that the extensions were not present in the Marketplace version available during setup, despite thorough investigation
...
This project reflects the following competencies:

- **Problem Solving** — Identifying blockers and working through them systematically
- **AI Tool Usage** — Working within Cursor and exploring AI-assisted development workflows
